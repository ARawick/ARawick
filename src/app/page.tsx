      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Total vendas de 90 dias</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-base sm:text-lg font-bold">132</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-center">
              <CardTitle className="text-lg sm:text-xl text-gray-600">Total de Pedidos</CardTitle>
